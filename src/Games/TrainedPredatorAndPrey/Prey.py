...
def _make_basis_matrix(wolf_r_divides,wolf_theta_divides,
    ...
    states_mat = wolf_states_mat + wall_states_mat
...
class Prey(Actor):
    ...
    def __init__(self, actor_id, start_posn,
        ...
        super().__init__(actor_id, start_posn, PREY, can_overlap=False)
        ...
        self.alpha = 0.5 # learning rate (consider how random the process is)
        ...
        self.live_reward = 1.0 # reward function (arbitrary)
    ...
    def get_state(self,observer):
        ...
        state_ind = self._dists_to_state_index(closest_preds,closest_walls)
    ...
    def act(self, observer):
        ...
        if random.random() < self.epsilon:
            ...
            probs = [prob + min_prob for prob in probs] # make everything positive
    ...
    def give_feedback(self, observer):
        ...
        if self.posn == observer.get_k_closest(PREDATOR,self.posn,1)[0]:
    ...
    def _dists_to_state_index(self,wolf_distances,wall_headings):
        ...
        wolf_coefs = self._distance_to_coefs(self.wolf_r_divides,\
                                             self.wolf_theta_divides, \
                                             wolf_distances)
        ...
        a = np.array(wolf_coefs + wall_coefs)
